...
* **Data Source**: We used the [Kaggle Reddit Climate Change dataset](https://www.kaggle.com/datasets/the-reddit-climate-change-dataset) containing comments discussing climate change.
